...
function Form({ handleSubmit, handleChange, formValue, text }) {
    ...
    return (
        <form onSubmit={handleSubmit} className='form h-[350px] relative w-[500px] rounded flex justify-center items-center flex-col'>
            ...
            <input autoComplete="off" type="text" name="text" placeholder={text.placeholder} onChange={handleChange} className="tokenize-input text-white m-[5px] rounded-[10px] h-[50px] w-[80%] bg-[rgba(197,158,255,0.2)] p-[10px] border-2 border-[rgb(197,158,255)]" /><br />
